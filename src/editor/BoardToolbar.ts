export type BoardTool = 'select' | 'route' | 'via' | 'line' | 'arc' | 'rect' | 'circle' | 'polygon' | 'bezier' | 'text' | 'text-box' | 'image' | 'barcode' | 'zone' | 'rule-area' | 'dimension-aligned' | 'dimension-orthogonal' | 'grid-origin' | 'drill-origin';
